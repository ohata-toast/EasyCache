...
### OSバージョンのアップグレード
* セキュリティ上の理由やお客様のニーズに応じて、レプリケーショングループを構成するノードに使用しているOSのバージョンをEasyCacheサービスが提供する最新バージョン(2024.08.13現在Ubuntu 22.04)にアップグレードできます。
...
| Redisメモリ使用量(rss) | Redsisメモリ使用量rss (bytes)                                           |                                   |
| メモリ断片化比率       | メモリ断片化比率(%)                                                       |                                   |
